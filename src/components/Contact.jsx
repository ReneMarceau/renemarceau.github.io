...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_jlazfvc', // paste your ServiceID here (you'll get one when your service is created).
        'template_o179xlr', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
